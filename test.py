...
for i in range(10):
    ...
    score1 = cs.add_score_statement(statement="i", params=[1, atk1, dur1, 0.5, 110*(i+1)])

atk2, dur2 = 0, 0
for j in range(15):
    atk2 += random.uniform(0, 6)
    dur2 = random.uniform(0, 1)
    score2 = cs.add_score_statement(statement="i", params=[2, atk2, dur2, 0.5, 90*(j+1)])

atk3, dur3 = 0, 0
for x in range(7):
    atk3 += random.uniform(0, 12)
    dur3 = random.uniform(0, 3)
    score2 = cs.add_score_statement(statement="i", params=[3, atk3, dur3, 0.5, 69*(x+1)])
